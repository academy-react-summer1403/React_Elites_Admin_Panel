...
const GoalOverview = props => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle tag='h4'> دوره های تایید شده </CardTitle>
      ...
      <Row className='border-top text-center mx-0'>
        <Col xs='6' className='border-end py-1'>
          <CardText className='text-muted mb-0'> تایید نشده </CardText>
          <h3 className='fw-bolder mb-0'> 30 </h3>
        </Col>
        <Col xs='6' className='py-1'>
          <CardText className='text-muted mb-0'>  تایید شده </CardText>
          <h3 className='fw-bolder mb-0'> 10 </h3>
        </Col>
      </Row>
    </Card>
  )
